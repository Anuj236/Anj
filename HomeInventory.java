...
inputFile.close(); currentEntry = 1;
...
myInventory[currentEntry - 1].description = itemTextField.getText(); myInventory[currentEntry - 1].location = locationComboBox.getSelectedItem().toString();
...
newButton.setEnabled(false); deleteButton.setEnabled(true);
...
storeTextField.setText(myInventory[j - 1].purchaseLocation); noteTextField.setText(myInventory[j - 1].note);
